@include('users.layouts.header')
    ...
    <main class="main">
                    ...
                    <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                        ...
                        <div class="product product-2">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product/details">MacBook Pro 13" Display, i5</a></h3><!-- End .product-title -->
                        ...
                        <div class="product product-2">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product/details">Bose - SoundLink Bluetooth Speaker</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $79.99
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                        ...
                        <div class="product product-2">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product/details">Apple - 11 Inch iPad Pro  with Wi-Fi 256GB </a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $899.99
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                        ...
                        <div class="product product-2">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product/details">Google - Pixel 3 XL  128GB</a></h3><!-- End .product-title -->
                                <div class="product-price">
                        ...
                        <div class="product product-2">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product/details">Samsung - 55" Class  LED 2160p Smart</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $899.99
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                                ...
                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                    ...
                                    <div class="product product-2">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="product/details">Bose - SoundSport  wireless headphones</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $199.99
                                            </div><!-- End .product-price -->
                                            <div class="ratings-container">
                                    ...
                                    <div class="product product-2">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="product/details">Microsoft - Refurbish Xbox One S 500GB</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $279.99
                                            </div><!-- End .product-price -->
                                            <div class="ratings-container">
                                    ...
                                    <div class="product product-2">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="product/details">Apple Watch Series 4 Gold Aluminum Case</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $499.99
                                            </div><!-- End .product-price -->
                                            <div class="ratings-container">
                                    ...
                                    <div class="product product-2">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="product/details">Sony - Class LED 2160p Smart 4K Ultra HD</a></h3><!-- End .product-title -->
                                            <div class="product-price">
        ...
        <div class="container for-you">
            <div class="heading heading-flex mb-3">
                <div class="heading-left">
                    <h2 class="title">Products you already like</h2><!-- End .title -->
                </div><!-- End .heading-left -->

                <div class="heading-right">
                    <a href="#" class="title-link">View All Product <i class="icon-long-arrow-right"></i></a>
                </div><!-- End .heading-right -->
            </div><!-- End .heading -->
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-2">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product/details">GoPro - HERO7 Black HD Waterproof Action</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $349.99
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-2">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product/details">Apple - Apple Watch Series 3 with White Sport Band</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $214.49
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-2">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product/details">Lenovo - 330-15IKBR 15.6"</a></h3><!-- End .product-title -->
                                <div class="product-price">
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-2">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product/details">Sony - Alpha a5100 Mirrorless Camera</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $499.99
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-2">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product/details">Home Mini - Smart Speaker  with Google Assistant</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $49.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-2">
                            <figure class="product-media">
                                <span class="product-label label-circle label-sale">Sale</span>
                                <a href="product/details">
                                    <img src="{{ asset('users/assets/images/demos/demo-4/products/product-16.jpg') }}" alt="Product image" class="product-image">
                                </a>
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product/details">WONDERBOOM Portable Bluetooth Speaker</a></h3><!-- End .product-title -->
                                <div class="product-price">
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product product-2">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product/details">Google - Home Hub with  Google Assistant</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $149.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
