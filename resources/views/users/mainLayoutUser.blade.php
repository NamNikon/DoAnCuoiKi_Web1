...
<body>
    <div class="page-wrapper">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="{{ asset('users/assets/images/products/cart/product-1.jpg') }}" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                                    ...
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="{{ asset('users/assets/images/products/cart/product-2.jpg') }}" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                                    ...
                                    <div class="megamenu demo">
                                        <div class="menu-col">
                                            ...
                                            <div class="demo-list">
                                                <div class="demo-item">
                                                    <a href="index-1.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/1.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-2.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/2.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-3.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/3.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-4.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/4.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-5.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/5.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-6.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/6.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-7.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/7.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-8.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/8.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-9.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/9.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-10.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/10.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-11.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/11.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-12.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/12.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-13.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/13.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-14.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/14.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-15.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/15.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-16.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/16.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-17.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/17.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-18.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/18.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-19.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/19.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-20.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/20.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-21.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/21.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-22.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/22.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-23.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/23.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-24.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('users/assets/images/menu/demos/24.jpg') }});"></span>
                                            ...
                                            <div class="col-md-4">
                                                <div class="banner banner-overlay">
                                                    <a href="category.html" class="banner banner-menu">
                                                        <img src="{{ asset('users/assets/images/menu/banner-1.jpg') }}" alt="Banner">
                                            ...
                                            <div class="col-md-6">
                                                <div class="banner banner-overlay">
                                                    <a href="category.html">
                                                        <img src="{{ asset('users/assets/images/menu/banner-2.jpg') }}" alt="Banner">
        ...
        <main class="main">
            <div class="intro-slider-container mb-5">
                <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl" 
                    ...
                    <div class="intro-slide" style="background-image: url({{ asset('users/assets/images/demos/demo-4/slider/slide-1.png') }});">
                    ...
                    <div class="intro-slide" style="background-image: url({{ asset('users/assets/images/demos/demo-4/slider/slide-2.png') }});">
                        <div class="container intro-content">
                            <div class="row justify-content-end">
                                <div class="col-auto col-sm-7 col-md-6 col-lg-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="category.html" class="cat-block">
                                <figure>
                                    <span>
                                        <img src="{{ asset('users/assets/images/demos/demo-4/cats/2.png') }}" alt="Category image">
                                    </span>
                                </figure>
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="category.html" class="cat-block">
                                <figure>
                                    <span>
                                        <img src="{{ asset('users/assets/images/demos/demo-4/cats/3.png') }}" alt="Category image">
                                    </span>
                                </figure>
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="category.html" class="cat-block">
                                <figure>
                                    <span>
                                        <img src="{{ asset('users/assets/images/demos/demo-4/cats/4.png') }}" alt="Category image">
                                    </span>
                                </figure>
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="category.html" class="cat-block">
                                <figure>
                                    <span>
                                        <img src="{{ asset('users/assets/images/demos/demo-4/cats/5.png') }}" alt="Category image">
                                    </span>
                                </figure>
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="category.html" class="cat-block">
                                <figure>
                                    <span>
                                        <img src="{{ asset('users/assets/images/demos/demo-4/cats/6.png') }}" alt="Category image">
                                    </span>
                                </figure>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6 col-lg-4">
                        <div class="banner banner-overlay banner-overlay-light">
                            <a href="#">
                                <img src="{{ asset('users/assets/images/demos/demo-4/banners/banner-1.png') }}" alt="Banner">
                            </a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="banner banner-overlay banner-overlay-light">
                            <a href="#">
                                <img src="{{ asset('users/assets/images/demos/demo-4/banners/banner-2.jpg') }}" alt="Banner">
                            </a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="banner banner-overlay banner-overlay-light">
                            <a href="#">
                                <img src="{{ asset('users/assets/images/demos/demo-4/banners/banner-3.png') }}" alt="Banner">
                            </a>
                    ...
                    <div class="tab-pane p-0 fade show active" id="new-all-tab" role="tabpanel" aria-labelledby="new-all-link">
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('users/assets/images/demos/demo-4/products/product-2.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{{ asset('users/assets/images/demos/demo-4/products/product-3.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{{ asset('users/assets/images/demos/demo-4/products/product-4.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    <span class="product-label label-circle label-top">Top</span>
                                    <a href="product.html">
                                        <img src="{{ asset('users/assets/images/demos/demo-4/products/product-5.jpg') }}" alt="Product image" class="product-image">
                                    </a>
            ...
            <div class="container">
                <div class="cta cta-border mb-5" style="background-image: url({{ asset('users/assets/images/demos/demo-4/bg-1.jpg') }});">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 deal-col">
                        <div class="deal" style="background-image: url('{{ asset('users/assets/images/demos/demo-4/deal/bg-1.jpg') }}');">
                            <div class="deal-top">
                    ...
                    <div class="col-lg-6 deal-col">
                        <div class="deal" style="background-image: url('{{ asset('users/assets/images/demos/demo-4/deal/bg-2.jpg') }}');">
                            <div class="deal-top">
            ...
            <div class="container">
                ...
                <div class="owl-carousel mt-5 mb-5 owl-simple" data-toggle="owl" 
                    ...
                    <a href="#" class="brand">
                        <img src="{{ asset('users/assets/images/brands/1.png') }}" alt="Brand Name">
                    </a>

                    <a href="#" class="brand">
                        <img src="{{ asset('users/assets/images/brands/2.png') }}" alt="Brand Name">
                    </a>

                    <a href="#" class="brand">
                        <img src="{{ asset('users/assets/images/brands/3.png') }}" alt="Brand Name">
                    </a>

                    <a href="#" class="brand">
                        <img src="{{ asset('users/assets/images/brands/4.png') }}" alt="Brand Name">
                    </a>

                    <a href="#" class="brand">
                        <img src="{{ asset('users/assets/images/brands/5.png') }}" alt="Brand Name">
                    </a>

                    <a href="#" class="brand">
                        <img src="{{ asset('users/assets/images/brands/6.png') }}" alt="Brand Name">
                    </a>
                </div><!-- End .owl-carousel -->
            </div><!-- End .container -->
                ...
                <div class="container trending-products">
                    ...
                    <div class="row">
                        <div class="col-xl-5col d-none d-xl-block">
                            <div class="banner">
                                <a href="#">
                                    <img src="{{ asset('users/assets/images/demos/demo-4/banners/banner-4.jpg') }}" alt="banner">
                                </a>
                            </div><!-- End .banner -->
                        </div><!-- End .col-xl-5col -->
                                ...
                                <div class="tab-pane p-0 fade show active" id="trending-top-tab" role="tabpanel" aria-labelledby="trending-top-link">
                                    <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                        ...
                                        <div class="product product-2">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="{{ asset('users/assets/images/demos/demo-4/products/product-7.jpg') }}" alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product product-2">
                                            <figure class="product-media">
                                                <span class="product-label label-circle label-new">New</span>
                                                <a href="product.html">
                                                    <img src="{{ asset('users/assets/images/demos/demo-4/products/product-8.jpg') }}" alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product product-2">
                                            <figure class="product-media">
                                                ...
                                                <span class="product-label label-circle label-sale">Sale</span>
                                                <a href="product.html">
                                                    <img src="{{ asset('users/assets/images/demos/demo-4/products/product-9.jpg') }}" alt="Product image" class="product-image">
                                                </a>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('users/assets/images/demos/demo-4/products/product-11.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                <figure class="product-media">
                                    <span class="product-label label-circle label-new">New</span>
                                    <a href="product.html">
                                        <img src="{{ asset('users/assets/images/demos/demo-4/products/product-12.jpg') }}" alt="Product image" class="product-image">
                                        <img src="{{ asset('users/assets/images/demos/demo-4/products/product-12-2.jpg') }}" alt="Product image" class="product-image-hover">
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('users/assets/images/demos/demo-4/products/product-13.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('users/assets/images/demos/demo-4/products/product-14.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('users/assets/images/demos/demo-4/products/product-15.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                <figure class="product-media">
                                    <span class="product-label label-circle label-sale">Sale</span>
                                    <a href="product.html">
                                        <img src="{{ asset('users/assets/images/demos/demo-4/products/product-16.') }}" alt="Product image" class="product-image">
                                    </a>
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('users/assets/images/demos/demo-4/products/product-17.jpg') }}" alt="Product image" class="product-image">
                                    </a>
        ...
        <footer class="footer">
            <div class="cta bg-image bg-dark pt-4 pb-5 mb-0" style="background-image: url({{ asset('users/assets/images/demos/demo-4/bg-5.jpg') }});">
                <div class="container">
                    <div class="row justify-content-center">
	            	...
	            	<div class="row">
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget widget-about">
	            				<img src="{{ asset('users/assets/images/demos/demo-4/logo-footer.png') }}" class="footer-logo" alt="Footer Logo" width="105" height="25">
	        ...
	        <div class="footer-bottom">
	        	<div class="container">
	        		...
	        		<figure class="footer-payments">
	        			<img src="{{ asset('users/assets/images/payments.png') }}" alt="Payment methods" width="272" height="20">
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="{{ asset('users/assets/images/popup/newsletter/logo.png') }}" class="logo" alt="logo" width="60" height="15">
                    ...
                    <div class="col-xl-2-5col col-lg-5 ">
                        <img src="{{ asset('users/assets/images/popup/newsletter/img-1.jpg') }}" class="newsletter-img" alt="newsletter">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="{{ asset('users/assets/js/jquery.hoverIntent.min.js') }}"></script>
    <script src="{{ asset('users/assets/js/jquery.waypoints.min.js') }}"></script>
    <script src="{{ asset('users/assets/js/superfish.min.js') }}"></script>
    <script src="{{ asset('users/assets/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('users/assets/js/bootstrap-input-spinner.js') }}"></script>
    <script src="{{ asset('users/assets/js/jquery.plugin.min.js') }}"></script>
    <script src="{{ asset('users/assets/js/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('users/assets/js/jquery.countdown.min.js') }}"></script>
    <!-- Main JS File -->
    <script src="{{ asset('users/assets/js/main.js') }}"></script>
    <script src="{{ asset('users/assets/js/demos/demo-4.js') }}"></script>
</body>
